                ...
                <form action="accion_radicar.php" method="post" class="needs-validation" novalidate>
                    <div class="row g-3">
                        <div class="col-sm-12">
                            ...
                            <input type="text" class="form-control" id="nombre" value="<?= $row->nombre_empleado ?>" required disabled>
                        ...
                        <div class="col-6">
                            ...
                            <input type="email" class="form-control" id="email" value="<?= $row->nombre_area ?>" required disabled>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-group has-validation">
                                <input type="text" class="form-control" id="cargo" value="<?= $row->nombre_cargo ?>" required disabled>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input id="fecha_inicio" class="form-control" type="datetime-local" value="<?= $row->fecha_inicio ?>" required disabled />
                        </div>
                        <div class="col-sm-6">
                            <label for="fecha_final" class="form-label">Fecha y Hora de Regreso</label>
                            <input id="fecha_final" class="form-control" type="datetime-local" value="<?= $row->fecha_final ?>" required disabled />
                        </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-4">
                                <button type="button" class="w-100 btn btn-success btn-lg" data-bs-toggle="modal" data-bs-target="#staticBackdropradicarsolicitud">
                                    Radicar solicitud
                                </button>
                            </div>
                            <!-- Modal radicar-->
                            <div class="modal fade" id="staticBackdropradicarsolicitud" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a href="#">
                                                <button type="subbmit" name="radicar" value="1" class="btn btn-success">Enviar</button>
                                            </a>
                                            <a href="#">
                            ...
                            <div class="modal fade" id="staticBackdropnegar" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a href="#">
                                                <button type="subbmit" name="negar" value="2" class="btn btn-secondary" data-bs-dismiss="modal">Enviar</button>
                                            </a>
                                            <a href="#">
                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
                                            </a>
                            ...
                            <div class="col-sm-4">
                                <button type="button" class="w-100 btn btn-warning btn-lg" data-bs-toggle="modal" data-bs-target="#staticBackdrop3">
                                    Pendiente
                                </button>
                            </div>
                            <!-- Modal pendientes-->
                            <div class="modal fade" id="staticBackdrop3" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="staticBackdropLabel"><b> Enviar a pendiente?</b></h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            <a href="#">
                                                <button type="subbmit" name="pendiente" value="3" class="btn btn-secondary" >Enviar</button>
                                            </a>
                                            <a href="#">
                                                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
                                            </a>
