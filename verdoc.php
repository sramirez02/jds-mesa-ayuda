                            ...
                            <form action="accion_modificar_s.php" method="post" class="needs-validation" novalidate>
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input id="fecha_final" class="form-control" type="datetime-local" name="fecha_final"
                                ...
                                <div class="row g-">
                                    <button type="button" class="w-100 btn btn-danger btn-lg" data-bs-toggle="modal"
                                        data-bs-target="#staticBackdropcancelar">
                                        Cancelar solicitud
                                    </button>
                                </div>
                                <!-- Modal cancelar -->
                                <div class="modal fade" id="staticBackdropcancelar" data-bs-backdrop="static" data-bs-keyboard="false"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a href="#">
                                                    <button type="subbmit" name="cancelar" value="2" class="btn btn-success"
                                ...
                                <div class="modal fade" id="staticBackdropcancelar" data-bs-backdrop="static" data-bs-keyboard="false"
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <a href="#">
                                                    <button type="subbmit" name="cancelar" value="1" class="btn btn-success"
                                                        data-bs-toggle="modal">Enviar</button>
                                                </a>
                                                <a href="#" <button type="button" class="btn btn-danger"
                                                    data-bs-dismiss="modal">Cerrar</button>
                            ...
                            <form action="accion_modificar_s.php" method="post" class="needs-validation" novalidate>
                                <div class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input id="fecha_inicio" class="form-control" type="datetime-local"
                                            min="<?= date('Y-m-d h:i') ?>" name="fecha_inicio" value="<?= $row->fecha_inicio ?>"
                                            required />
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="fecha_final" class="form-label">Fecha y Hora de Regreso</label>
                                        <input id="fecha_final" class="form-control" type="datetime-local"
                                            min="<?= date('Y-m-d h:i') ?>" name="fecha_final" value="<?= $row->fecha_final ?>"
                                            required />
                                    </div>
                                ...
                                <div class="row g-">
                                    <button type="button" class="w-100 btn btn-success btn-lg" data-bs-toggle="modal"
                                        data-bs-target="#staticBackdropmodificar">
                                        Modificar solicitud
                                    </button>
                                </div>

                                <!-- Modal modificar -->
                                <div class="modal fade" id="staticBackdropmodificar" data-bs-backdrop="static" data-bs-keyboard="false"
                                    tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                            ...
                                            <div class="modal-footer">
                                                <a href="#">
                                                    <button type="subbmit" name="modificar" value="3" class="btn btn-success"
                                                        data-bs-toggle="modal">Enviar</button>
                                                </a>
                                                <a href="#" <button type="button" class="btn btn-danger"
                                                    data-bs-dismiss="modal">Cerrar</button>
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" class="form-control" id="nombre" name="nombre"
                                                            placeholder="Nombre" value="<?= $row->nombre_empleado ?>" required disabled>
                                                        <div class="invalid-feedback">
                                                            Valid first name is required.
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text" class="form-control" id="area" name="area"
                                                            placeholder="Area o Dependencia" value="<?= $row->nombre_area ?>" required
                                                            disabled>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <input type="text" class="form-control" id="cargo" name="cargo"
                                                            placeholder="Cargo" value="<?= $row->nombre_cargo ?>" required disabled>
                                                        <!--div-->
                                                    </div>
                                                    <hr>
                                                    <div class="col-sm-6">
                                                        <label for="fecha_inicio" class="form-label">Fecha y Hora de salida</label>
                                                        <input id="fecha_inicio" class="form-control" type="datetime-local"
                                                            name="fecha_inicio" value="<?= $row->fecha_inicio ?>" required disabled />
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label for="fecha_final" class="form-label">Fecha y Hora de Regreso</label>
                                                        <input id="fecha_final" class="form-control" type="datetime-local"
                                                            name="fecha_final" value="<?= $row->fecha_final ?>" required disabled />
                                                    </div>
                                                ...
                                                <div class="row gy-6">
                                                    <div class="col-md-12">
                                                        ...
                                                        <textarea class="form-control" rows="2" id="observaciones" name="observaciones"
                                                            required disabled><?= $row->observaciones ?></textarea>
                                                    </div>
                                                </div>
                                                <hr>
                                        <?php }
